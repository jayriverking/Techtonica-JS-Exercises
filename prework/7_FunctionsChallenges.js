...
function includes(collection, value, index = 0) {
    ...
    if (typeof collection === 'string' || typeof collection === 'array') {
      //for loop - starting index = index, added a default index value of 0 to the parameter
  ...
  console.log(includes([1, 2, 3], 1, 2)); // --> false - shouldn't this be true? the value of  1 is included in [1, 2, 3]
