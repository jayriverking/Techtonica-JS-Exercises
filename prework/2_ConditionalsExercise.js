...
//     console.log(exercise6(8, 8, 12));
//   console.log(exercise6(12, 5, 6));
...
//   console.log(exercise7(101));
  ...
  function exercise8(amount1, amount2, minimum, maximum) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
    if(minimum < (amount1 && amount2) && (amount1 && amount2) < maximum){
        answer8 = true;
    }
    else {
        answer8 = false;
...
//     console.log(exercise8(1, 2, 0, 8));
//   console.log(exercise8(12, 10, 5, 6));
...
//   console.log(exercise10(6));
  
  // Congrats, you made it to the end! You rock!
  // Did you find this easy or hard? If you used references, which ones helped you?
  // Please answer in a comment below.
  /* It was pretty easy - exercise 8 kind of confused me while I was writing 
  the conditional statement but I did a simple check and I think it works as expected */
